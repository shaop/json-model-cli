...
describe('JSONModel 测试', function() {
    it('json 1 基础测试', function () {
        ...
        liner.open('./resources/mjExtension/mjModel1.h');
        let theline1;
        while (!liner._EOF) {
            theline1 = liner.next();
        ...
        liner.open('./resources/mjExtension/mjModel1.m');
        let theline2;
        while (!liner._EOF) {
            theline2 = liner.next();
    ...
    it('json 2 嵌套测试', function () {
        ...
        liner.open('./resources/mjExtension/mjModel2.h');
        let theline1;
        while (!liner._EOF) {
            theline1 = liner.next();
            if (theline1 !== undefined) {
        ...
        liner.open('./resources/mjExtension/mjModel2.m');
        let theline2;
        while (!liner._EOF) {
            theline2 = liner.next();
            if (theline2 !== undefined) {
